...
export const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/cartoes', label: 'Cartões', icon: CreditCard, available: false },
  { to: '/orcamento', label: 'Orçamento', icon: PiggyBank, available: false },
  { to: '/calendario', label: 'Calendário financeiro', icon: CalendarDays, available: false },
  ...
  { to: '/importar', label: 'Importar dados', icon: Upload, available: false },
